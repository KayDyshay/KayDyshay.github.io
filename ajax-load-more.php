...
<head>
	...
	<title>Vision Board - Kanesha Dyshay</title>
	...
	<div id="overlay-menu" class="overlay-menu">
		...
		<div class="overlay-menu-inner">
			<nav class="overlay-menu-nav">
				...
				<li class="slidedown"><a href="index.html">Home</a></li>
				<li class="slidedown">
		...
		<section id="hero" class="module-hero module-parallax module-full-height bg-light-30" data-background="assets/images/section-4.jpg">
			...
			<div class="hero-caption">
				<div class="hero-text">
					...
					<h1 class="mh-line-size-1 font-alt m-b-50">Kanesha Dyshay</h1>
					<h5 class="mh-line-size-4 font-alt">Web Developer & UI Design</h5>
